...
class Dataset(FrozenDict):
    ...
    def sample_sequence(self, batch_size, sequence_length, discount):
        ...
        batch_mc_returns = self['mc_returns'][all_idxs].reshape(batch_size, sequence_length) if 'mc_returns' in self._dict else None
        ...
        if batch_mc_returns is not None:
            result['mc_returns'] = batch_mc_returns
        return result
