...
class TrainState(flax.struct.PyTreeNode):
    ...
    def __call__(self, *args, params=None, method=None, mutable=None, **kwargs):
        """Forward pass.
        ...
        Args:
            *args: Arguments to pass to the model.
            ...
            mutable: List of collections that are mutable. If batch_stats exist and mutable is not specified,
                     it defaults to ['batch_stats'].
        ...
        # Include batch_stats if they exist
        if self.batch_stats is not None:
            variables['batch_stats'] = self.batch_stats
            # If mutable is not specified but we have batch_stats, make them mutable
            if mutable is None and 'training' in kwargs and kwargs.get('training', False):
                mutable = ['batch_stats']
        ...
        # Add mutable parameter if specified
